...
namespace ContosoUniversity.Migrations
{
    ...
    [Migration("20210427015244_mejoras-documentos-nacionalidad")]
    partial class mejorasdocumentosnacionalidad
    {
            ...
            modelBuilder.Entity("ContosoUniversity.Models.ConversionMoneda", b =>
                {
                    ...
                    b.Property<int?>("MonenaDestinoID")
                        .HasColumnType("int");

                    b.Property<int?>("MonenaOrigenID")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("MonenaDestinoID");

                    b.HasIndex("MonenaOrigenID");
            ...
            modelBuilder.Entity("ContosoUniversity.Models.ConversionMoneda", b =>
                {
                    ...
                    b.HasOne("ContosoUniversity.Models.Moneda", "MonenaDestino")
                        .WithMany()
                        .HasForeignKey("MonenaDestinoID");

                    b.HasOne("ContosoUniversity.Models.Moneda", "MonenaOrigen")
                        .WithMany()
                        .HasForeignKey("MonenaOrigenID");

                    b.Navigation("MonedaDestino");

                    b.Navigation("MonedaOrigen");

                    b.Navigation("MonenaDestino");

                    b.Navigation("MonenaOrigen");
                });
